...
var janus = null;
var sfutest = null;
var opaqueId = "videoroomrtsptest-"+Janus.randomString(12);
			...
			janus = new Janus(
				{
					...
					success: function() {
						...
						janus.attach(
							{
								plugin: "janus.plugin.ds.videoroom.rtsp",
								opaqueId: opaqueId,
									...
									if (medium == "video") {
										...
										const request = { 
											message: { 
												...
												// host: "n8s.site",
												host_family: "ipv4",
												streams: [ { mid: mid, port: 8001 } ]
											}
										};
										Janus.log("request:", request);
										const result = sfutest.send(request);
										Janus.log("forward rtp Result: ", result);
									}
								},
											...
											if(msg["streams"]) {
												...
												if(msg["error_code"] === 426) {
													...
													bootbox.alert(
														...
														"does not exist...</p><p>Do you have an updated <code>janus.plugin.ds.videoroom.rtsp.jcfg</code> " +
	...
	sfutest.createOffer(
		{
			...
			success: function(jsep) {
				...
				// refer to the text in janus.plugin.ds.videoroom.rtsp.jcfg for more details.
